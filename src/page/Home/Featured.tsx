const FeaturesSection = () => {
  return (
    <section className="relative min-h-screen  w-screen flex flex-col items-center justify-center lg:text-start text-center bg-white py-16 px-4 lg:px-32 overflow-hidden">
      ...
      <div className="absolute lg:block hidden w-20 h-20 bg-gradient-to-r from-yellow-300 to-pink-400 rounded-full top-1/2 right-0 opacity-30  -translate-y-1/2"></div>
      ...
      <div className="absolute lg:hidden w-24 h-24 bg-gradient-to-r from-yellow-300 to-pink-400 rounded-full bottom-1/4 right-0 opacity-30  -translate-y-1/2"></div>
