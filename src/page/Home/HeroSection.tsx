...
const HeroSection = () => {
  return (
    <section className="flex flex-col-reverse lg:gap-5 lg:flex-row  items-center justify-between  bg-[#fdfdfd] relative overflow-hidden w-screen min-h-[100vh] lg:px-36 px-5 py-28  lg:py-0">
      {/* bulat */}
      ...
      <div className="lg:w-1/2 w-full text-center lg:text-left">
        <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 leading-tight mb-6">
          ...
          Unique Sound of the <br className="hidden lg:block" />
          <span className="text-gray-800">Original Didgeridoo</span>
        </h1>
        <p className="text-gray-500 text-lg mb-8 max-w-xl">
          A high quality didgeridoo collection, made with love by experienced
          craftsmen. The culture and distinctive sound of this traditional
      ...
      <div className="lg:w-1/2 w-full  flex justify-center  relative mb-12 lg:mb-0 ">
        <div className="relative z-10 lg:w-72 w-44 mx-auto lg:mx-0 lg:h-[400px] h-60 bg-orange-200 border-2 border-dashed rounded-t-full">
          <img
